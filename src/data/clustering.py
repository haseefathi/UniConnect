...
csv_filepathname = "data\clustering_data.csv"
...
pd.to_numeric(df1['acceptance_rate'])
pd.to_numeric(df1['average_gre'])
pd.to_numeric(df1['min_gre'])
pd.to_numeric(df1['max_gre'])
pd.to_numeric(df1['average_gre_verbal'])
pd.to_numeric(df1['min_gre_verbal'])
pd.to_numeric(df1['max_gre_verbal'])
pd.to_numeric(df1['average_gre_quant'])
pd.to_numeric(df1['min_gre_quant'])
pd.to_numeric(df1['max_gre_quant'])
pd.to_numeric(df1['min_gpa'])
pd.to_numeric(df1['max_gpa'])
pd.to_numeric(df1['average_writing'])
pd.to_numeric(df1['min_writing'])
pd.to_numeric(df1['max_writing'])
# print (df1)



print('----------------------------------converted relevant stuff to numeric------------------------------')
...
print(X)
plt.scatter(X[:, 1], X[:, 10], s=150, zorder = 5)
...
print('---------------------------------- showing the clustering plot ------------------------------')
plt.xlim(xmin=260, xmax=341)
plt.ylim(ymin=1.5, ymax=4.1)
plt.xlabel('gre')
plt.ylabel('gpa')
